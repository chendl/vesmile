...
public class ResourceLoader {
	...
	public static URL getResource(String rpath) {
		...
		try {
			...
			URL cpUrl = ResourceLoader.class.getResource("");
			String classPath = "";
			if (cpUrl == null) {
				classPath = ResourceLoader.class.getClassLoader().getResource(
						"")
						+ "";
				String resourceAbsolutePath = classPath + rpath;
